...
const EntryPlus = () => {
  ...
  const handleMemberInputChange = (e: React.ChangeEvent<HTMLInputElement>) => {
    ...
    //멤버객체값을 변경한다.
    console.log('onChange이벤트가 발생한 UI요소의 name', e.target.name);
    console.log('onChange이벤트가 발생한 UI요소의 name', e.target.value);
  ...
  //회원가입 버튼 클릭 onSubmit 이벤트 처리기함수 정의하기
